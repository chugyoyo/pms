...
public class SwaggerConfiguration {
    ...
    public Docket apiDocket() {
        return newGroupDocket("对外接口", "com.xin.controller.api", AuthConsts.CLIENT_AUTHORIZATION_HEADER);
    }
    ...
    public Docket admApiDocket() {
        return newGroupDocket("管理后台接口", "com.xin.controller.admin", AuthConsts.AUTHORIZATION_HEADER);
    }
